...
parser.add_argument('--layer_num', type=int, default=45, help='phase number of POCS-Net')
...
parser.add_argument('--log_dir', type=str, default='loss_validation2d', help='log directory')
...
with torch.no_grad():
    for epoch_i in range(start_epoch+1, end_epoch+1):
        ...
        sio.savemat("./%s/Loss_validation%d_lr_%.4f_layernum_%02d.mat"%(args.log_dir,epoch_i,learning_rate,layer_num),{"Loss_epoch_validation":Loss_epoch})
