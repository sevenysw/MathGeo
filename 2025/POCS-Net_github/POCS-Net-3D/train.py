...
parser.add_argument('--model_dir', type=str, default='model_pre&post', help='trained or pre-trained model directory')
parser.add_argument('--data_dir', type=str, default='data', help='training data directory')
parser.add_argument('--log_dir', type=str, default='log_pre&post', help='log directory')
