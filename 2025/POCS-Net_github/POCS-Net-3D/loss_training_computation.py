...
parser.add_argument('--end_epoch', type=int, default=35, help='epoch number of end validation')
...
parser.add_argument('--log_dir', type=str, default='loss_training_pre&post', help='log directory')
...
if start_epoch > 0:
    Loss_epoch = sio.loadmat("./%s/Loss_training_epoch_%d_lr_%.4f_layernum_%02d.mat"%(args.log_dir,start_epoch,learning_rate,layer_num))
