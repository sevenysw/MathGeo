...
optimizer = torch.optim.Adam([v], lr=100)
...
#mu matrix
mu = torch.ones(model_dim[0],model_dim[1])
mu_ele1 = torch.linspace(1,100,100)
mu_ele2 = torch.linspace(100,10000,40)
...
lamda_ele1 = torch.linspace(5,2,140)
lamda_ele2 = torch.linspace(1,1,230)
lamda_ele3 = torch.linspace(2,5,140)
...
# lamda = torch.ones(model_dim[0],model_dim[1])
# lamda_ele1 = torch.linspace(1,30,165)
# lamda_ele2 = torch.linspace(30,1,165)
...
#                                                                                   loss.item()))
    ...
    loss1 = 10*TGV(v,1)+1*shearlet(v,device)
