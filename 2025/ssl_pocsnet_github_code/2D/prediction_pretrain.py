...
parser.add_argument('--save_dir', type=str, default='prediction_result_35_pretrain', help='save directory for results')
...
model.load_state_dict(torch.load('./%s/net_params_%d.pkl' % ('model', epoch)))
